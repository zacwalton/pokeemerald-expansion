...
extern const u8 BattleScript_ApotropaismEnds[];
...
extern const u8 BattleScript_EffectAuraSense[];
...
extern const u8 BattleScript_EffectApotropaism[];
...
extern const u8 BattleScript_EffectFreeze[];
