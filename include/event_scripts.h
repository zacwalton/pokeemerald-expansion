...
extern const u8 EventScript_UseSweetScent[];
...
extern const u8 EventScript_UseLava[];
extern const u8 EventScript_UseSludge[];
...
extern const u8 EventScript_FieldBurn[];
