...
enum {
    ...
    MAPSEC_NAVEL_ROCK,
    MAPSEC_TRAINER_HILL,
    MAPSEC_SLATEPORT_LIGHTHOUSE,
    MAPSEC_ROUTE_111_DESERT,
    MAPSEC_PETALBURG_WOODS2,
    MAPSEC_METEOR_FALLS3,
    MAPSEC_FORINA,
    MAPSEC_DEWFORD_ISLAND,
    MAPSEC_OLDALE_RUINS,
    MAPSEC_OLD_POWER_PLANT,
    MAPSEC_DONTO_ISLAND,
    MAPSEC_GIBAN_ISLAND,
    MAPSEC_VALLEY_OF_STEEL,
    MAPSEC_WILD_ISLAND,
    MAPSEC_VERDALE_FALLS,
    MAPSEC_ROUTE_111_SOUTH,
    MAPSEC_MT_CHIMNEY_BASE,
    MAPSEC_BOMBA_ISLAND,
    MAPSEC_IZABE_ISLAND,
    MAPSEC_IZABE_ISLAND2,
    MAPSEC_RIYADO_TOWN,
    MAPSEC_ROUTE_135,
    MAPSEC_NONE,
    MAPSEC_COUNT
