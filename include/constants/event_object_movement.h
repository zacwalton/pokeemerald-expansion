...
#define MOVEMENT_ACTION_WALK_FAST_DIAGONAL_UP_LEFT      0xA6	// fast diagonal movement
...
#define MOVEMENT_ACTION_DOUSE_FIRE					    0xAA

#define MOVEMENT_ACTION_WALK_SLOW_STAIRS_DOWN           0xAB
#define MOVEMENT_ACTION_WALK_SLOW_STAIRS_UP             0xAC
#define MOVEMENT_ACTION_WALK_SLOW_STAIRS_LEFT           0xAD
#define MOVEMENT_ACTION_WALK_SLOW_STAIRS_RIGHT          0xAE

#define MOVEMENT_ACTION_SURF_STILL_DOWN                 0xAF
#define MOVEMENT_ACTION_SURF_STILL_UP                   0xB0
