...
#define MAP_RUGGED_SEA            (57 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE107   (58 | (0 << 8))
#define MAP_RUGGED_SEA_SLATEPORT  (59 | (0 << 8))
#define MAP_OLDALE_RUINS          (60 | (0 << 8))
#define MAP_OLD_POWER_PLANT       (61 | (0 << 8))
#define MAP_VERDALE_FALLS         (62 | (0 << 8))
#define MAP_SEA_MAUVILLE          (63 | (0 << 8))
#define MAP_DEWFORD_ISLAND        (64 | (0 << 8))
#define MAP_RUSTBORO_PIER         (65 | (0 << 8))
#define MAP_FORINA                (66 | (0 << 8))
#define MAP_VALLEY_OF_STEEL       (67 | (0 << 8))
#define MAP_ROUTE111_SOUTH        (68 | (0 << 8))
#define MAP_ROUTE111_NORTH        (69 | (0 << 8))
#define MAP_ROUTE111_DESERT       (70 | (0 << 8))
#define MAP_MT_CHIMNEY_EXTERIOR   (71 | (0 << 8))
#define MAP_METEOR_FALLS_EXTERIOR (72 | (0 << 8))
#define MAP_SLATEPORT_LIGHTHOUSE  (73 | (0 << 8))
#define MAP_ROUTE118EAST          (74 | (0 << 8))
#define MAP_SAFARI_ZONE_NW        (75 | (0 << 8))
#define MAP_SAFARI_ZONE_SW        (76 | (0 << 8))
#define MAP_SAFARI_ZONE_NE        (77 | (0 << 8))
#define MAP_SAFARI_ZONE_SE        (78 | (0 << 8))
#define MAP_ROUTE119_SOUTH        (79 | (0 << 8))
#define MAP_GIBAN_ISLAND          (80 | (0 << 8))
#define MAP_WILD_IDLAND_NORTH     (81 | (0 << 8))
#define MAP_WILD_ISLAND_SOUTH     (82 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE132   (83 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE118   (84 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE133   (85 | (0 << 8))
#define MAP_ROUTE126_SOUTH        (86 | (0 << 8))
#define MAP_ROUTE126_EAST         (87 | (0 << 8))
#define MAP_ROUTE126_WEST         (88 | (0 << 8))
#define MAP_ROUTE126_NORTH        (89 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE126   (90 | (0 << 8))
