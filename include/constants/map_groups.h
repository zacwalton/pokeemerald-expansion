...
#define MAP_RUGGED_SEA_LITTLEROOT      (57 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE107        (58 | (0 << 8))
#define MAP_RUGGED_SEA_SLATEPORT       (59 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE118        (60 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE126        (61 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE132        (62 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE133        (63 | (0 << 8))
#define MAP_OLDALE_RUINS               (64 | (0 << 8))
#define MAP_OLD_POWER_PLANT            (65 | (0 << 8))
#define MAP_VERDALE_FALLS              (66 | (0 << 8))
#define MAP_SEA_MAUVILLE               (67 | (0 << 8))
#define MAP_DEWFORD_ISLAND             (68 | (0 << 8))
#define MAP_RUSTBORO_PIER              (69 | (0 << 8))
#define MAP_FORINA                     (70 | (0 << 8))
#define MAP_VALLEY_OF_STEEL            (71 | (0 << 8))
#define MAP_ROUTE111_SOUTH             (72 | (0 << 8))
#define MAP_ROUTE111_NORTH             (73 | (0 << 8))
#define MAP_ROUTE111_DESERT            (74 | (0 << 8))
#define MAP_MT_CHIMNEY_EXTERIOR        (75 | (0 << 8))
#define MAP_METEOR_FALLS_EXTERIOR      (76 | (0 << 8))
#define MAP_SLATEPORT_LIGHTHOUSE       (77 | (0 << 8))
#define MAP_MT_PYRE_EXT                (78 | (0 << 8))
#define MAP_SAFARI_ZONE_NW             (79 | (0 << 8))
#define MAP_SAFARI_ZONE_SW             (80 | (0 << 8))
#define MAP_SAFARI_ZONE_NE             (81 | (0 << 8))
#define MAP_SAFARI_ZONE_SE             (82 | (0 << 8))
#define MAP_ROUTE119_SOUTH             (83 | (0 << 8))
#define MAP_GIBAN_ISLAND               (84 | (0 << 8))
#define MAP_WILD_ISLAND_NORTH          (85 | (0 << 8))
#define MAP_WILD_ISLAND_SOUTH          (86 | (0 << 8))
#define MAP_ROUTE126_SOUTH             (87 | (0 << 8))
#define MAP_ROUTE126_EAST              (88 | (0 << 8))
#define MAP_ROUTE126_WEST              (89 | (0 << 8))
#define MAP_ROUTE126_NORTH             (90 | (0 << 8))
#define MAP_LILYCOVE_BAY               (91 | (0 << 8))
#define MAP_ROUTE122_WEST              (92 | (0 << 8))
#define MAP_ROUTE124_SOUTH             (93 | (0 << 8))
#define MAP_ROUTE127_NORTH             (94 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE131        (95 | (0 << 8))
#define MAP_SKY_PILLAR_EXTERIOR        (96 | (0 << 8))
#define MAP_DONTO_ISLAND               (97 | (0 << 8))
#define MAP_RUGGED_SEA_ROUTE130        (98 | (0 << 8))
#define MAP_WILD_ISLAND_EAST           (99 | (0 << 8))
#define MAP_RUGGED_SEA_BATTLE_FRONTIER (100 | (0 << 8))
