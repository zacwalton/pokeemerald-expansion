...
#define STATUS4_APOTROPAISM				(1 << 7)    // Only used if B_SPORT_TURNS < GEN_6
...
#define SIDE_STATUS_FORESIGHT               (1 << 23)
#define SIDE_STATUS_MIRACLE_EYED            (1 << 24)
...
#define STATUS_FIELD_APOTROPAISM					(1 << 12)
