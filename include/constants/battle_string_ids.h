...
enum StringID
{
	...
	STRINGID_PKMNWASDEFROSTEDSUN,
	STRINGID_PKMNISALREADYFROZEN,
	STRINGID_PKMNPREVENTSFREEZEWITH,
	STRINGID_APOTROPAISMENDS,
	STRINGID_FAIRYWEAKENED,
    STRINGID_COUNT
};
