...
static const u16 sSpecialFlyDestinations[][4] =
{
    ...
    {
        FLAG_LANDMARK_SOUTHERN_ISLAND, MAPSEC_SOUTHERN_ISLAND, 0, 0
    },
    {
        -1,
        MAPSEC_NONE
...
u8 GetMapsecType(u16 mapSecId)
{
    switch (mapSecId)
    {
        ...
        case MAPSEC_SOUTHERN_ISLAND:
            return FlagGet(FLAG_LANDMARK_SOUTHERN_ISLAND) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_NONE;
		case MAPSEC_MT_CHIMNEY:
			return FlagGet(FLAG_VISITED_MT_CHIMNEY) ? MAPSECTYPE_BATTLE_FRONTIER : MAPSECTYPE_NONE;
