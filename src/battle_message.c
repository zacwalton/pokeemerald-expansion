...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNWASDEFROSTEDSUN]                  = COMPOUND_STRING("{B_DEF_NAME_WITH_PREFIX} defrosted in the sun!"),
    ...
    [STRINGID_PKMNIDENTIFIED]                       = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} identified its foe(s)!"),
    ...
    [STRINGID_FAIRYWEAKENED]                         = COMPOUND_STRING("Fairy's power was weakened!"),
    ...
    [STRINGID_TARGETIDENTIFIED]                     = COMPOUND_STRING("{B_ATK_NAME_WITH_PREFIX} identified its foe(s)!"),
    ...
    [STRINGID_APOTROPAISMENDS]                      = COMPOUND_STRING("The effects of Apotropaism have faded."),
