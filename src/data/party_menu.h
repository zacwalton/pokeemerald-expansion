...
} static const sFieldMoveCursorCallbacks[FIELD_MOVES_COUNT] =
{
    ...
    [FIELD_MOVE_IRON_HEAD]  = {SetUpFieldMove_Headbutt,  PARTY_MSG_CANT_USE_HERE},
    [FIELD_MOVE_METEOR_MASH]  = {SetUpFieldMove_Headbutt,  PARTY_MSG_CANT_USE_HERE},
    [FIELD_MOVE_DYNAMIC_PUNCH]  = {SetUpFieldMove_Headbutt,  PARTY_MSG_CANT_USE_HERE},
    [FIELD_MOVE_DOUBLE_IRON_BASH]  = {SetUpFieldMove_Headbutt,  PARTY_MSG_CANT_USE_HERE},
