...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_MASQUERAIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_WATER_1, EGG_GROUP_BUG),
        .abilities = { ABILITY_DAUNTING_WINGS, ABILITY_NONE, ABILITY_UNNERVE },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_WHISMUR] =
    {
        ...
        .abilities = { ABILITY_CACOPHONY, ABILITY_NONE, ABILITY_RATTLED },
    ...
    [SPECIES_LOUDRED] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_MONSTER, EGG_GROUP_FIELD),
        .abilities = { ABILITY_CACOPHONY, ABILITY_NONE, ABILITY_SCRAPPY },
        .bodyColor = BODY_COLOR_BLUE,
    ...
    [SPECIES_TROPIUS] =
    {
        ...
        .evYield_HP = 2,
        .itemCommon = ITEM_HARD_FRUIT,
        .itemRare = ITEM_SWEET_FRUIT,
        .genderRatio = PERCENT_FEMALE(50),
        .eggCycles = 25,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_SLOW,
    ...
    #if P_UPDATED_ABILITIES >= GEN_4
        .abilities = { ABILITY_HARVEST, ABILITY_WIND_RIDER, ABILITY_THICK_FAT },
    #else
