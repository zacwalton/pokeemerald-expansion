...
const u32 gObjectEventPic_LargeFire[] = INCBIN_U32("graphics/object_events/pics/misc/large_fire.4bpp");
const u32 gObjectEventPic_SewerGrate[] = INCBIN_U32("graphics/object_events/pics/misc/sewer_grate.4bpp");
