...
enum {
    ...
    FIELD_MOVE_STEEL_ROLLER,
    FIELD_MOVE_METAL_CLAW,
    FIELD_MOVE_FRENZY_PLANT,
    FIELD_MOVE_ICE_SPINNER,
    FIELD_MOVE_SLASH,
    FIELD_MOVE_LEAF_BLADE,
	FIELD_MOVE_RAZOR_LEAF,
	FIELD_MOVE_FURY_CUTTER,
	FIELD_MOVE_IRON_TAIL,
	FIELD_MOVE_AERIAL_ACE,
	FIELD_MOVE_NIGHT_SLASH,
	FIELD_MOVE_X_SCISSOR,
	FIELD_MOVE_PSYCHO_CUT,
	FIELD_MOVE_CROSS_POISON,
	FIELD_MOVE_SACRED_SWORD,
	FIELD_MOVE_RAZOR_SHELL,
	FIELD_MOVE_STEAMROLLER,
	FIELD_MOVE_SECRET_SWORD,
	FIELD_MOVE_ROTOTILLER,
	FIELD_MOVE_BEHEMOTH_BLADE,
	FIELD_MOVE_STONE_AXE,
	FIELD_MOVE_CEASELESS_EDGE,
	FIELD_MOVE_POPULATION_BOMB,
	FIELD_MOVE_PSYBLADE,
	FIELD_MOVE_BITTER_BLADE,
	FIELD_MOVE_MIGHTY_CLEAVE,
	FIELD_MOVE_TACHYON_CUTTER,
    FIELD_MOVE_FALSE_SWIPE,
	FIELD_MOVE_AQUA_CUTTER,
    FIELD_MOVE_GUILLOTINE,
    FIELD_MOVE_KOWTOW_CLEAVE,
	// Smash
    FIELD_MOVE_ROCK_SMASH,  // FLAG_BADGE03_GET
    FIELD_MOVE_BRICK_BREAK,
    FIELD_MOVE_BULLDOZE,
    FIELD_MOVE_HEAD_CHARGE,
    FIELD_MOVE_HEAD_SMASH,
    FIELD_MOVE_FOCUS_PUNCH,
    FIELD_MOVE_HAMMER_ARM,
    FIELD_MOVE_HORN_DRILL,
    FIELD_MOVE_SUPERPOWER,
    FIELD_MOVE_WOOD_HAMMER,
    FIELD_MOVE_IRON_HEAD,
    FIELD_MOVE_METEOR_MASH,
    FIELD_MOVE_DOUBLE_IRON_BASH,
	FIELD_MOVE_ROCK_THROW,
	FIELD_MOVE_CRABHAMMER,
	FIELD_MOVE_ROCK_BLAST,
	FIELD_MOVE_BULLET_PUNCH,
	FIELD_MOVE_ROCK_WRECKER,
	FIELD_MOVE_ICE_HAMMER,
	FIELD_MOVE_DRAGON_HAMMER,
	FIELD_MOVE_BEHEMOTH_BASH,
	FIELD_MOVE_STEEL_BEAM,
	FIELD_MOVE_PSYSHIELD_BASH,
	FIELD_MOVE_HYPER_DRILL,
	FIELD_MOVE_GIGATON_HAMMER,
	FIELD_MOVE_ICE_BLITZ,
	// Shake
    FIELD_MOVE_HEADBUTT,
    FIELD_MOVE_DYNAMIC_PUNCH,
    FIELD_MOVE_LOW_KICK,
    FIELD_MOVE_VINE_WHIP,
	FIELD_MOVE_ICY_WIND,
	FIELD_MOVE_TWISTER,
	FIELD_MOVE_TAILWIND,
	FIELD_MOVE_SMACK_DOWN,
	FIELD_MOVE_LEAF_TORNADO,
	FIELD_MOVE_HURRICANE,
	FIELD_MOVE_PETAL_BLIZZARD,
	FIELD_MOVE_SPRINGTIDE_STORM,
	FIELD_MOVE_BLEAKWIND_STORM,
	FIELD_MOVE_WILDBOLT_STORM,
	FIELD_MOVE_SANDSEAR_STORM,
	// Push
    FIELD_MOVE_STRENGTH,    // FLAG_BADGE04_GET
    FIELD_MOVE_BODY_PRESS,
    FIELD_MOVE_TELEKINESIS,
	// Climb
	FIELD_MOVE_ROCK_CLIMB,
	FIELD_MOVE_ACROBATICS,
	// Surf
    ...
    FIELD_MOVE_DAZZLING_GLEAM,
    FIELD_MOVE_FLASH_CANNON,
    FIELD_MOVE_SPOTLIGHT,
    FIELD_MOVE_TAIL_GLOW,
    FIELD_MOVE_POWER_GEM,
    FIELD_MOVE_BURN_UP,
    FIELD_MOVE_EMBER,
    FIELD_MOVE_BLUE_FLARE,
    FIELD_MOVE_SACRED_FIRE,
    FIELD_MOVE_TORCH_SONG,
    FIELD_MOVE_FLAMETHROWER,
    FIELD_MOVE_LAVA_PLUME,
	FIELD_MOVE_AURORA_BEAM,
	FIELD_MOVE_LUSTER_PURGE,
	FIELD_MOVE_DOOM_DESIRE,
	FIELD_MOVE_LIGHT_OF_RUIN,
	FIELD_MOVE_ORIGIN_PULSE,
	FIELD_MOVE_SOLAR_BLADE,
	FIELD_MOVE_FLEUR_CANNON,
	FIELD_MOVE_PRISMATIC_LASER,
	FIELD_MOVE_MOONGEIST_BEAM,
	FIELD_MOVE_LUMINA_CRASH,
	FIELD_MOVE_FICKLE_BEAM,
    FIELD_MOVE_SPARK,
    FIELD_MOVE_SUNSTEEL_STRIKE,
    FIELD_MOVE_ELECTRO_BALL,
    FIELD_MOVE_PHOTON_GEYSER,
	// Lava Surf
	// Heal
    FIELD_MOVE_MILK_DRINK,
    FIELD_MOVE_SOFT_BOILED,
    FIELD_MOVE_LIFE_DEW,
    FIELD_MOVE_JUNGLE_HEALING,
    FIELD_MOVE_LUNAR_BLESSING,
	// Jump
	// Warp
    FIELD_MOVE_FLY,         // FLAG_BADGE06_GET
	FIELD_MOVE_DRAGON_ASCENT,
	FIELD_MOVE_EXTREME_SPEED,
	// Hack
    FIELD_MOVE_CHARGE_BEAM,
    FIELD_MOVE_DISCHARGE,
    FIELD_MOVE_PARABOLIC_CHARGE,
    FIELD_MOVE_CHATTER,
	// Defog
    FIELD_MOVE_AIR_CUTTER,
    FIELD_MOVE_WHIRLWIND,
    FIELD_MOVE_DEFOG,
    FIELD_MOVE_GUST,
    FIELD_MOVE_AEROBLAST,
    FIELD_MOVE_AIR_SLASH,
	// Escape
    FIELD_MOVE_TELEPORT,
    FIELD_MOVE_DIG,
    FIELD_MOVE_PHANTOM_FORCE,
    FIELD_MOVE_SHADOW_FORCE,
	// Lure
    FIELD_MOVE_SWEET_SCENT,
    FIELD_MOVE_AROMATIC_MIST,
	// Secret
    FIELD_MOVE_SECRET_POWER,
	// Sludge Surf		
    FIELD_MOVE_SLUDGE_WAVE,
	// Douse
    FIELD_MOVE_WATER_GUN,
	FIELD_MOVE_HYDRO_PUMP,
	FIELD_MOVE_BLIZZARD,
	FIELD_MOVE_SMOKESCREEN,
	FIELD_MOVE_SMOG,
	FIELD_MOVE_RAIN_DANCE,
	FIELD_MOVE_HYDRO_CANNON,
	FIELD_MOVE_WATER_SPOUT,
	FIELD_MOVE_MUD_SHOT,
	FIELD_MOVE_AQUA_RING,
	FIELD_MOVE_SOAK,
	FIELD_MOVE_SCALD,
	FIELD_MOVE_WATER_PLEDGE,
	FIELD_MOVE_CHILLING_WATER,
    FIELD_MOVE_FLASH_FREEZE,
	// Reveal
	FIELD_MOVE_FORESIGHT,
	FIELD_MOVE_ODOR_SLEUTH,
	FIELD_MOVE_MIRACLE_EYE,
	FIELD_MOVE_DETECT,
    FIELD_MOVE_AURA_SENSE,
    FIELD_MOVE_LIDAR_LOCK,
    FIELD_MOVE_EXTRASENSORY,
    FIELD_MOVE_EERIE_IMPULSE,
    FIELD_MOVES_COUNT
};
    ...
    for (i = 0; i < sPartyMenuInternal->numActions; i++)
    {
		...
		if (sPartyMenuInternal->actions[i] >= MENU_FIELD_MOVES)
				if (gMovesInfo[sFieldMoves[sPartyMenuInternal->actions[i] - MENU_FIELD_MOVES]].fieldMoveFlags & IS_FIELD_MOVE_PUSH)
					...
					fontColorsId = 12; //Dynamic 5 (Aquamarine)
